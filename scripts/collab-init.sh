...
# G8 (v0.4.2): numeric three-part semver compare. Inputs MUST be valid
# semver X.Y.Z (detect_mode validates installed; shipped is controlled).
...
# G8 (v0.4.2): migration sentinel helpers.
...
# The chain runner is the SOLE writer of sentinels — migration scripts
# themselves are unchanged in v0.4.2.
